---
title: "The influence of non-driving related tasks on take-over quality in highly automated driving - a multilevel meta-analysis"
author: "Tim Certa"
...
### Visualization: Funnel Plot
```{r}
funnel(overall_wo, main = "Standard Error", xlab = "Hedges'sg")
```
...
summary(trimfill)
funnel(trimfill,main = "Standard Error", xlab = "Hedges'sg") 
```
